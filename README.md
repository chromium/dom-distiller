...
reviews, the [Chromium Rietveld code review tool](https://codereview.chromium.org/)
...
-   For password, use your GitHub password.
    ...
    -   If you have two-factor authentication enabled, create a personal access
        token at your [application settings page](https://github.com/settings/applications)
